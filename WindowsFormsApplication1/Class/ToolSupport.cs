...
namespace WindowsFormsApplication1.Class
{
    public class ToolSupport
    {
        ...
        public void ExportTimeKeepingDaily(List<EmployeeTimekeeping> employeeTimekeepings, string pathSave, string pathForm, DateTime date) // Vu thêm vào 15/1/2022
        {
            Excel.Application xlApp;
            Excel.Workbook xlWorkBook;
            Excel.Worksheet xlWorkSheet;
            ...
            try
            {
                ...
                //   string CurrentDep = attendanceDepts[0].BigDeptCode;
                int countGroup = 0;
                xlWorkSheet.Cells[4, "A"] = "TIMEKEEPING REPORT ON " + date.ToString("dd-MM-yyyy");
                for (int i = 0; i < employeeTimekeepings.Count; i++)
                {
                    xlWorkSheet.Cells[7 + i, "A"] = (i + 1).ToString();
                    xlWorkSheet.Cells[7 + i, "B"] = employeeTimekeepings[i].Date;
                    xlWorkSheet.Cells[7 + i, "C"] = employeeTimekeepings[i].Dept;
                    xlWorkSheet.Cells[7 + i, "D"] = employeeTimekeepings[i].EmpCode;
                    xlWorkSheet.Cells[7 + i, "E"] = employeeTimekeepings[i].EmpName;
                    xlWorkSheet.Cells[7 + i, "F"] = employeeTimekeepings[i].TimeCheck;
                    xlWorkSheet.Cells[7 + i, "G"] = employeeTimekeepings[i].ShiftCode;
                    xlWorkSheet.Cells[7 + i, "H"] = employeeTimekeepings[i].Shift;
                }
